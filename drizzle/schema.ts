...
export const workspaceMembers = pgTable("workspace_members", {
	...
	role: varchar("role", { length: 50 }).default('member'::character varying).notNull(),
...
export const sprints = pgTable("sprints", {
	...
	description: text("description"),
	projectId: uuid("project_id").notNull().references(() => projects.id),
	status: varchar("status", { length: 20 }).default('planning'::character varying).notNull(),
...
export const bugs = pgTable("bugs", {
	...
	description: text("description"),
	status: varchar("status", { length: 20 }).default('open'::character varying).notNull(),
	severity: varchar("severity", { length: 20 }).default('medium'::character varying).notNull(),
	projectId: uuid("project_id").notNull().references(() => projects.id),
...
export const profiles = pgTable("profiles", {
	...
	systemRole: varchar("system_role", { length: 50 }).default('member'::character varying).notNull(),
...
export const tasks = pgTable("tasks", {
	...
	status: varchar("status", { length: 20 }).default('todo'::character varying).notNull(),
	assigneeId: varchar("assignee_id", { length: 255 }).references(() => profiles.id),
	dueDate: timestamp("due_date", { mode: 'string' }),
